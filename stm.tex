...
These features are implemented through external liraries like \codeify{stm} \cite{rustSTM} and \codeify{async-stm-rs} \cite{asyncRustSTM}. Former provides STM support for Rust, while the latter async programming support for Rust.\\ 
